<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <img src="{{ asset('images/john.jpg') }}" alt="logo" class="img-fluid rounded-circle img-responsive" style="width: 30px; margin-left: 50px">
    <h5 class="p-2">Cellphone Reservation</h5>
    <ul class="navbar-nav">
        <li class="nav-item active">
          <a style="border-right: 1px rgba(89, 89, 89, 0.356) solid;" class="nav-link text-dark" href="{{ '/' }}">Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="{{ '/contact' }}">Cellphones</a>
        </li>
      </ul>
